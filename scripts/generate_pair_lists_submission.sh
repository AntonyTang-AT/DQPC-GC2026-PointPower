...
#
# Data layout (organizer-provided):
#   $GC2026_ROOT/data/raw/UVG-CWI-DQPC/<Sequence>/consumer-grade_capture_system/CG/15fps/
#   $GC2026_ROOT/data/raw/UVG-CWI-DQPC/<Sequence>/high-end_capture_system/HE/15fps/
set -euo pipefail
